...
describe('moduleCtrl', function (Setup, md5) {
	var corebosAPIGateWay = Setup.marvelapi;
	...
	beforeEach(inject(function ($controller, $rootScope, $httpBackend) {
		...
		httpMock.expectJSONP(
				corebosAPIGateWay + 'comics?apikey=' + marvelPublicKey + '&ts=' + marvelTS + '&hash=' + marvelHash + '&callback=JSON_CALLBACK')
		.respond(
